...
namespace Aen {
	...
	namespace Concealed {
		...
		const MatT<float, 3u, 3u>& MatT<float, 3u, 3u>::operator= (const MatT<float, 3u, 4u>& rhs) {
			m00 = rhs.m00;
			m01 = rhs.m01;
			m02 = rhs.m02;
			m10 = rhs.m10;
		...
		const MatT<float, 3u, 3u>& MatT<float, 3u, 3u>::operator= (const MatT<float, 4u, 3u>& rhs) {
			m00 = rhs.m00;
			m01 = rhs.m01;
			m02 = rhs.m02;
			m10 = rhs.m10;
		...
		const MatT<float, 3u, 3u>& MatT<float, 3u, 3u>::operator= (const MatT<float, 4u, 4u>& rhs) {
			m00 = rhs.m00;
			m01 = rhs.m01;
			m02 = rhs.m02;
			m10 = rhs.m10;
		...
		const MatT<float, 3u, 4u>& MatT<float, 3u, 4u>::operator= (const MatT<float, 3u, 3u>& rhs) {
			m00 = rhs.m00;
			m01 = rhs.m01;
			m02 = rhs.m02;
			m10 = rhs.m10;
		...
		const MatT<float, 3u, 4u>& MatT<float, 3u, 4u>::operator= (const MatT<float, 4u, 3u>& rhs) {
			m00 = rhs.m00;
			m01 = rhs.m01;
			m02 = rhs.m02;
			m10 = rhs.m10;
		...
		const MatT<float, 3u, 4u>& MatT<float, 3u, 4u>::operator= (const MatT<float, 4u, 4u>& rhs) {
			m00 = rhs.m00;
			m01 = rhs.m01;
			m02 = rhs.m02;
			m03 = rhs.m03;
		...
		const MatT<float, 4u, 3u>& MatT<float, 4u, 3u>::operator= (const MatT<float, 3u, 3u>& rhs) {
			m00 = rhs.m00;
			m01 = rhs.m01;
			m02 = rhs.m02;
			m10 = rhs.m10;
		...
		const MatT<float, 4u, 3u>& MatT<float, 4u, 3u>::operator= (const MatT<float, 3u, 4u>& rhs) {
			m00 = rhs.m00;
			m01 = rhs.m01;
			m02 = rhs.m02;
			m10 = rhs.m10;
		...
		const MatT<float, 4u, 3u>& MatT<float, 4u, 3u>::operator= (const MatT<float, 4u, 4u>& rhs) {
			m00 = rhs.m00;
			m01 = rhs.m01;
			m02 = rhs.m02;
			m10 = rhs.m10;
		...
		const MatT<float, 4u, 4u>& MatT<float, 4u, 4u>::operator= (const MatT<float, 3u, 3u>& rhs) {
			m00 = rhs.m00;
			m01 = rhs.m01;
			m02 = rhs.m02;
			m10 = rhs.m10;
		...
		const MatT<float, 4u, 4u>& MatT<float, 4u, 4u>::operator= (const MatT<float, 3u, 4u>& rhs) {
			m00 = rhs.m00;
			m01 = rhs.m01;
			m02 = rhs.m02;
			m03 = rhs.m03;
		...
		const MatT<float, 4u, 4u>& MatT<float, 4u, 4u>::operator= (const MatT<float, 4u, 3u>& rhs) {
			m00 = rhs.m00;
			m01 = rhs.m01;
			m02 = rhs.m02;
			m10 = rhs.m10;
	...
	void Sphere::CreateFromAABB(const OBB& box) noexcept {
	...
	const float ACos(const float& n) noexcept {
		return DirectX::XMScalarACos(n);
	}
	const float ASin(const float& n) noexcept {
		return DirectX::XMScalarASin(n);
	}
	const float Cos(const float& n) noexcept {
		return DirectX::XMScalarCos(n);
	}
	const float Sin(const float& n) noexcept {
